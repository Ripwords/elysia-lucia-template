...
cron job attached to it. The cron job is scheduled to run at midnight every day (pattern: "0 0 * *
*") and its task is to asynchronously delete expired sessions using the
